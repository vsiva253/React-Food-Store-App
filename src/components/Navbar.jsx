...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex   justify-between items-center p-4'>
        ...
        <div className='bg-gray-200  flex items-center px-2 md:w-[400px] sm:w-[300px] lg: w-[200px] rounded-full'>
            {/*search input*/}
            <AiOutlineSearch size={25}/>
            <input className='bg-transparent p-2 m-0 w-full focus:outline-none' type='text' placeholder='search foods'/>
        </div>
        <div>
            <button className='bg-black text-white lg:w-auto md:flex item-center py-1 rounded-full'>
